			...
			<div class="element-container">
				...
				<ul class="foot_index">
					...
					while ($donnees = $reponse->fetch()) {	?>						
							<li><a href="http://127.0.0.1/split/game.php?genre=<?php echo $donnees['title'];?>"> <?php echo $donnees[$_SESSION['user']['langue']]; ?> </a></li>
						<?php }?>
				</ul>
				<ul class="foot_index">
					<li><a href="http://127.0.0.1/split/game.php?genre=<?php echo $dat1['title']; ?>"><?php echo $dat1[$_SESSION['user']['langue']];?></a></li>
				</ul>
			</div>
		</div>
	</div> <!-- body-->
