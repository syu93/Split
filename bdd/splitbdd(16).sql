...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 24 Avril 2014 à 02:02
...
INSERT INTO `game` (`id`, `position`, `tag`, `title`, `text_fr`, `text_en`, `textlongue_fr`, `textlongue_en`, `price`, `ideditor`, `pegi`, `licence`, `active`, `connected`, `url`) VALUES
...
('2', 0, 'game', 'battlefield3', 'Battlefield3', '', 'Battlefield3', 'Battlefield3', 45, NULL, NULL, NULL, 0, 1, 'gameImg/battlefield3.jpg'),
...
('5', 0, 'game', 'assasinscreed4', 'Assasin''s Creed IV Black Flag', 'Assasin''s Creed IV Black Flag', '1715, les Pirates rÃ¨gnent sur les CaraÃ¯bes et viennent de fonder leur propre RÃ©publique oÃ¹ la corruption, lâ€™avarice et la cruautÃ© sont dÃ©sormais monnaie courante. Parmi ces hors-la-loi, un jeune capitaine impÃ©tueux du nom dâ€™Edward Kenway commence Ã  se forger une flatteuse rÃ©putation.', 'The year is 1715. Pirates rule the Caribbean and have established their own lawless Republic where corruption, greediness and cruelty are commonplace. Among these outlaws is a brash young captain named Edward Kenway.', 50, NULL, NULL, NULL, 0, 1, 'gameImg/assasinscreed4.jpg'),
...
('12', 0, 'game', 'dayz', 'DayZ', 'DayZ', 'ATTENTION : CE JEU EST UNE VERSION ALPHA EN ACCÃˆS ANTICIPÃ‰. MERCI D''ACHETER CE JEU UNIQUEMENT SI VOUS SOUHAITEZ PARTICIPER ACTIVEMENT AU DÃ‰VELOPPEMENT DU JEU ET ÃŠTES PRÃŠT Ã€ SUBIR DES PROBLÃˆMES POUVANT ENTRAÃŽNER UN MAUVAIS FONCTIONNEMENT ET DES INTERRUPTIONS DANS LE JEU.', 'WARNING: THIS GAME IS EARLY ACCESS ALPHA. PLEASE DO NOT PURCHASE IT UNLESS YOU WANT TO ACTIVELY SUPPORT DEVELOPMENT OF THE GAME AND ARE PREPARED TO HANDLE WITH SERIOUS ISSUES AND POSSIBLE INTERRUPTIONS OF GAME FUNCTIONING.', 30, NULL, NULL, NULL, 0, 1, 'gameImg/dayz.jpg'),
('13', 0, 'game', 'deadisland', 'Dead Island', 'Dead Island', 'Un lieu de villÃ©giature paradisiaque se transforme en enfer aprÃ¨s une invasion de zombies.', 'A holiday paradise gone mad. A tropical island turns into total chaos after a mysterious zombie outbreak.', 15, NULL, NULL, NULL, 0, 1, 'gameImg/deadisland.jpg'),
...
('15', 0, 'game', 'dota2', 'Dota 2', 'Dota 2', 'Dota a tout d''abord Ã©tÃ© une modification faite par des joueurs de Warcraft 3 et a fini par Ãªtre un des jeux les plus jouÃ©s au monde. Suivant la tradition de Counter-Strike, Day of Defeat, Team Fortress, Portal et Alien Swarm, Dota 2 est le fruit du recrutement des dÃ©veloppeurs de la communautÃ© qui a construit cette modification et de...', 'Dota is a competitive game of action and strategy, played both professionally and casually by millions of passionate fans worldwide. Players pick from a pool of over a hundred heroes, forming two teams of five players.', 0, NULL, NULL, NULL, 0, 1, 'gameImg/dota2.jpg'),
('16', 0, 'game', 'empiretotalwar', 'Empire: Total War', 'Empire: Total War', 'Prenez le contrÃ´le des mers, de la terre et construisez une nation pour partir Ã  la conquÃªte du globe.', 'Command the seas, control the land, forge a new nation, and conquer the globe.', 15, NULL, NULL, NULL, 0, 1, 'gameImg/empiretotalwar.jpg'),
...
CREATE TABLE IF NOT EXISTS `gamegenre` (
  ...
  `idgenre` varchar(100) NOT NULL DEFAULT '0',
