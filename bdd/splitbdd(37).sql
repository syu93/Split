...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 17 Juin 2014 à 03:40
...
(51, 0, 'orderok', 'text', 'Nous avons procéder avec succès à votre commande, vous recevrez un email de confirmation. <br> Merci pour votre commande. <br> L''équipe de Split.', 'We have successfully proceed to your order, you will receive an email of confirmation.<br> Thank You for your order.<br><br>The Split team.', NULL, NULL, 0),
(52, 0, 'ordererr', 'text', 'Une erreur s''est produite pendant que nous procédons à votre commande de ".$c_game.".<br> Notre technicien tentera de le corriger dès que possible, <br> Vous pouvez également essayer à nouveau de faire votre commande. <br> Nous sommes désolé pour ce désagrément <br> L''équipe de Split.', 'An error occurred while we proceed to your order of ".$c_game.".<br> Our technician will try to fix it as soon as possible,<br> You can also try again to make your order.<br> We are sorry for this inconvenience<br><br>The Split team.', NULL, NULL, 0),
(53, 0, 'subject', 'text', 'Sujet', 'Subject', NULL, NULL, 0);
...
INSERT INTO `forum` (`id`, `forum`, `thread`, `user`, `message`, `date`) VALUES
(1, 'partner', 'Mon premier forum', 'herve.tutuaku@gmail.com', 'Créer un forum est plus dur que ce que je pensait. j''ai réussit mais je vais me coucher super tard pour finir.', '2014-06-17 00:25:26'),
(2, 'event', 'Notre premier évenement', 'herve.tutuaku@gmail.com', 'Notre premier évenement', '2014-06-17 00:35:31'),
(3, 'forum', 'Moin Tu Dors Plus T''es Fort', 'herve.tutuaku@gmail.com', 'Tout ça pour dire que je suis claquer', '2014-06-17 00:53:50');
...
('brothers', '0000-111-000-00-0000', 'herve.tutuaku@gmail.com'),
...
('2014-06-16 11:45:26', '0001-20140616', 'herve.tutuaku@gmail.com', '2014-06-16'),
('2014-06-16 11:58:07', '0001-20140616', 'herve.tutuaku@gmail.com', '2014-06-16'),
('2014-06-16 12:04:28', '0001-20140616', 'herve.tutuaku@gmail.com', '2014-06-16');
...
INSERT INTO `orderdetails` (`idorder`, `idgame`) VALUES
('0001-20140616', '7daystodie'),
('0001-20140616', 'brothers');
...
INSERT INTO `partner` (`name`, `email`, `password`, `avatar`, `registred`) VALUES
('Qteam', 'herve.tutuaku@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '', '2014-06-16');
