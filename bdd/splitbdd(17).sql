...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 28 Avril 2014 à 00:50
...
(2, 0, 'Action', 'menu', 'Action', 'Action', '', '0', 1),
(3, 3, 'adventure', 'menu', 'Aventure', 'Adventure', '', '0', 1),
(4, 2, 'strategie', 'menu', 'Strategie', 'Strategy', '', '0', 1),
(5, 3, 'rpg', 'menu', 'Jeux de role', 'Role Play', NULL, '0', 1),
(6, 4, 'mmo', 'menu', 'MMO', 'MMO', '', '0', 1),
...
(10, 20, 'cart', 'menu', 'Mon Panier', 'My Cart', NULL, '1', 1),
(11, 0, 'signup', 'text', 'Bienvenue', 'Welcome', NULL, '1', 1),
(12, 0, 'logoff', 'text', 'DÃ©connexion', 'Log off', '', '1', 1),
