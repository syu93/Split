...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 19 Mai 2014 à 00:12
...
(0, 'game', 'tower wars', 'Tower Wars', 'Tower Wars', 'Tower Wars combine des lments de tower defense, RTS, et tout- multi-joueurs chaos pour vous apporter une exprience tout  fait unique, livr avec un style amusant et drle qui n''est pas si vieux monde!', 'Tower Wars combines elements of tower defense, RTS, and all-out multi-player mayhem to bring you a completely unique experience, delivered with a fun and funny not-so-old world style!', 6.99, '', 12, NULL, 0, 0, 'gameImg/towerwars.jpg', ''),
(0, 'game', 'endless legend', 'Endless Legend', 'Endless Legend', 'Endless Legend est un jeu de stratgie 4X fantastique au tour par tour par les crateurs d''Endless Space et de Dungeon of the Endless. Crez votre propre Lgende!', 'Endless Legend is a 4X turn-based fantasy strategy game by the creators of Endless Space and Dungeon of the Endless. Create your own Legend!', 22.49, '', 16, NULL, 0, 0, 'gameImg/endlesslegend.jpg', ''),
