...
--
-- Client :  127.0.0.1
-- Généré le :  Sam 08 Mars 2014 à 01:45
...
CREATE TABLE IF NOT EXISTS `editor` (
  ...
  `text_ang` varchar(1000) NOT NULL,
  `game` int(100) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `editor` (`id`, `name`, `text_fr`, `text_ang`, `game`) VALUES
(1, 'Electronic Arts', 'Electronic Arts', 'Electronic Arts', 0);
...
CREATE TABLE IF NOT EXISTS `gamegenre` (
  ...
  `idgame` int(100) NOT NULL DEFAULT '0',
